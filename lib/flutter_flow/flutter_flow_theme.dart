...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFCBA500);
  late Color secondary = const Color(0xFFD3D3D3);
  late Color tertiary = const Color(0xFFCBA500);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFFEEEEEE);
  late Color secondaryText = const Color(0xFF171717);
  ...
  late Color backgroundComponents = Color(0xFFC3B8B8);
  late Color bgInput = Color(0xFFE9EAEE);
}
