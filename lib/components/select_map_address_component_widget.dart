...
import 'select_map_address_component_model.dart';
export 'select_map_address_component_model.dart';
...
class _SelectMapAddressComponentWidgetState
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                'd3fgepjg' /* Ubicación de la compañia */,
                              ),
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'SELECT_MAP_ADDRESS_COMPONENT_Icon_jgn2t8');
