      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('PAYMENT_arrow_back_rounded_ICN_ON_TAP');
              ...
              child: Column(
                ...
                children: [
                  Align(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        '85p9p0wg' /* Membresia y Facturación */,
                      ),
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'pm8n2ba5' /* Información de facturación */,
                        ),
                        textAlign: TextAlign.start,
                        style:
                            FlutterFlowTheme.of(context).headlineSmall.override(
                                        ...
                                        children: [
                                          Text(
                                            ...
                                            style: FlutterFlowTheme.of(context)
                                                ...
                                                .override(
                                                  fontFamily: 'Poppins',
                                                  color: Color(0xFF275099),
                                                  fontWeight: FontWeight.w600,
                                                ),
                                          ),
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              'ut4hg7ns' /* Servicio de la plataforma */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
